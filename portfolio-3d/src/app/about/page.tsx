...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "anaveen0908@gmail",
    href: "mailto:anaveen0908@gmail.com",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/alivnavc",
    content: "/alivnavc",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Naveen, an AI Engineer who turns research into production. For
              5+ years I&apos;ve designed agentic and multi-agent systems, built retrieval-augmented
              pipelines, and fine-tuned and served large language models in the real world &mdash;
              from a $1M/year cost-saving SLM pipeline to serving 70B-parameter models at low latency.
            </p>
            <p className="mb-10">
              I care about systems that are fast, reliable, and genuinely understood &mdash; which is
              why I also build interactive explainers that show exactly how these models work, with
              every number computed live.
            </p>
